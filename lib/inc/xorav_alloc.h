...
extern "C"
{
  ...
  static inline size_t xorav_strncopy(char *dst, size_t bufsize,
...
#define XORAV_STRSET(field, src) \
  xorav_strset((field), sizeof(field), (src))

#define XORAV_STRNSET(field, src, maxlen) \
    xorav_strnset((field), sizeof(field), (src), (maxlen))
